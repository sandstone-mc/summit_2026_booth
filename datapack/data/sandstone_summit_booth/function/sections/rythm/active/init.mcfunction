...
execute as @a[tag=ssb.player] run function sandstone_summit_booth:sections/rythm/active/init/execute_as
gamerule natural_health_regeneration false
function sandstone_summit_booth:sections/rythm/active/init/if
function sandstone_summit_booth:sections/rythm/songs/play
function sandstone_summit_booth:sections/rythm/songs/schedule_walls
