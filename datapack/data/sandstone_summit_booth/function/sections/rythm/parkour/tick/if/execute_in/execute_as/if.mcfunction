...
scoreboard players add @s sandstone_summit_booth.ssb_pts 15
execute if score @s sandstone_summit_booth.ssb_cmb matches ..9 run scoreboard players set @s sandstone_summit_booth.ssb_cmb 10
