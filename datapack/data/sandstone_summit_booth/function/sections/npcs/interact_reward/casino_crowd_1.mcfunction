...
execute as @e[tag=sandstone_summit_booth.npc.casino_crowd_1, type=minecraft:mannequin] run function sandstone_summit_booth:sections/npcs/interact_reward/casino_crowd_1/execute_as/if