...
execute as @e[type=minecraft:mannequin, tag=sandstone_summit_booth.npc.casino_crowd_2, tag=sandstone_summit_booth.npc.casino_crowd_2] run function sandstone_summit_booth:sections/npcs/interact_reward/casino_crowd_2/execute_as