...
execute as @e[type=minecraft:mannequin, tag=sandstone_summit_booth.npc.casino_crowd_3] run function sandstone_summit_booth:sections/npcs/interact_reward/casino_crowd_3/execute_as