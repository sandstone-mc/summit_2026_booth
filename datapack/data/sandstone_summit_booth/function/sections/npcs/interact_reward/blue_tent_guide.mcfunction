...
execute as @e[tag=sandstone_summit_booth.npc.blue_tent_guide, type=minecraft:mannequin] run function sandstone_summit_booth:sections/npcs/interact_reward/blue_tent_guide/execute_as/if