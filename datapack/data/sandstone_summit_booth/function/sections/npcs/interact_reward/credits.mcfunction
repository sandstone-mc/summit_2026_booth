...
execute as @e[tag=sandstone_summit_booth.npc.credits, type=minecraft:mannequin] run function sandstone_summit_booth:sections/npcs/interact_reward/credits/execute_as