...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 5 run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_5/show/if59
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_5/show/__sleep60/_context 1t replace