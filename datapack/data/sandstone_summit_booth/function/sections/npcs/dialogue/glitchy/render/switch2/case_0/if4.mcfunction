...
scoreboard players remove @s sandstone_summit_booth.npc.dialogue.reveal_cut 43
data modify storage sandstone_summit_booth:npcs_reveal full set value 'TypeScript'
...
data modify storage sandstone_summit_booth:npcs_reveal runs set value [{text:'This whole booth?\nJust lines of '},{text:'code',color:'light_purple'},{text:".\nIt's "},{text:'',color:'blue'}]
data modify storage sandstone_summit_booth:npcs_reveal runs[3].text set from storage sandstone_summit_booth:npcs_reveal cut
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/render/switch2/case_0/if4/execute_at