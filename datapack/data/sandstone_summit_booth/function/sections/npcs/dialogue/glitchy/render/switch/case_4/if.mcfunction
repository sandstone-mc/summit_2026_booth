...
data modify storage sandstone_summit_booth:npcs_reveal full set value 'Anyway. Now you know the secret. Take this as a token of your new knowledge.'
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/render/switch/case_4/if/execute_at