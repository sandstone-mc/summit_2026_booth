...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 3 run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_3/show/if82
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_3/show/__sleep83/_context 1t replace