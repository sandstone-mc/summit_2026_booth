...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 1 run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_1/variant_0/if42
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_1/variant_0/__sleep43/_context 1t replace