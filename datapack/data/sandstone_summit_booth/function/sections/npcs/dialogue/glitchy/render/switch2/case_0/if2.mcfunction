...
scoreboard players remove @s sandstone_summit_booth.npc.dialogue.reveal_cut 32
data modify storage sandstone_summit_booth:npcs_reveal full set value 'code'
...
data modify storage sandstone_summit_booth:npcs_reveal runs set value [{text:'This whole booth?\nJust lines of '},{text:'',color:'light_purple'}]
data modify storage sandstone_summit_booth:npcs_reveal runs[1].text set from storage sandstone_summit_booth:npcs_reveal cut
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/render/switch2/case_0/if2/execute_at