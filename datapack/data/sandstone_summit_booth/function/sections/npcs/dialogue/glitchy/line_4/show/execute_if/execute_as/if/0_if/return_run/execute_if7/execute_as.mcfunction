...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_4/show/execute_if/execute_as/if/0_if/return_run/execute_if7/execute_as/execute_at
