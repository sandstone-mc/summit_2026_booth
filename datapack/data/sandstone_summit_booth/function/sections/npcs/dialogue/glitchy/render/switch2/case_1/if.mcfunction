...
data modify storage sandstone_summit_booth:npcs_reveal full set value "Truth is I'm not even a real player, I'm just a mannequin"
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/render/switch2/case_1/if/execute_at