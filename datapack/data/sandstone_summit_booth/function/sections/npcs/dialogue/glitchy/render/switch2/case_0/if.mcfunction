...
data modify storage sandstone_summit_booth:npcs_reveal full set value 'This whole booth?\nJust lines of '
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/render/switch2/case_0/if/execute_at