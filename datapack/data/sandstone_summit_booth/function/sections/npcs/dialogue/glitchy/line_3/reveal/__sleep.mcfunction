...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 3 run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_3/reveal/if
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_3/reveal/__sleep2/_context 2t replace