...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 0 run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_0/show/if10
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_0/show/__sleep11/_context 1t replace