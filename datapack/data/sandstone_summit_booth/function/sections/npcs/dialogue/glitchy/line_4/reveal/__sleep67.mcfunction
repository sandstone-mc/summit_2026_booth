...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 4 run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_4/reveal/if67
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_4/reveal/__sleep68/_context 1t replace