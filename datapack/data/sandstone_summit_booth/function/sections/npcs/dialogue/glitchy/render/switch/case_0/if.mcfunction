...
data modify storage sandstone_summit_booth:npcs_reveal full set value 'aaaaaaaaaaa'
...
data modify storage sandstone_summit_booth:npcs_reveal runs set value [{text:'',obfuscated:true}]
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/render/switch/case_0/if/execute_at