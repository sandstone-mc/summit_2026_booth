...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 0 run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_0/show/if6
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_0/show/__sleep7/_context 1t replace