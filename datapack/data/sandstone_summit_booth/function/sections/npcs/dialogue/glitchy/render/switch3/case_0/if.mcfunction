...
data modify storage sandstone_summit_booth:npcs_reveal full set value "And guess what...\n\nThey don't want you to know this, but this whole island is just a simulation"
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/render/switch3/case_0/if/execute_at