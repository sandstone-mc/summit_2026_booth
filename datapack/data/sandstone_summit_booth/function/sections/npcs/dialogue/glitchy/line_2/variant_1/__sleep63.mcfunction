...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 2 run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_2/variant_1/if63
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_2/variant_1/__sleep64/_context 1t replace