...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 2 run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_2/show/if69
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_2/show/__sleep70/_context 1t replace