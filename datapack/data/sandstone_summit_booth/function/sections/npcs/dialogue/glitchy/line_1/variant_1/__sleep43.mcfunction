...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 1 run function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_1/variant_1/if43
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/glitchy/line_1/variant_1/__sleep44/_context 1t replace