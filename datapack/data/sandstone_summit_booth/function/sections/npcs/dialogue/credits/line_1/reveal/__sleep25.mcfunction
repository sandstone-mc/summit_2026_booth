...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 1 run function sandstone_summit_booth:sections/npcs/dialogue/credits/line_1/reveal/if25
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/credits/line_1/reveal/__sleep26/_context 1t replace