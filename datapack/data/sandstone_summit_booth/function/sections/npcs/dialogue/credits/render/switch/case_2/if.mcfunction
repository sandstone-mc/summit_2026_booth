...
data modify storage sandstone_summit_booth:npcs_reveal full set value "Click me again and I'll tell you about them."
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/credits/render/switch/case_2/if/execute_at