execute if entity @s[tag=sandstone_summit_booth.npc.blue_tent_guide] run function sandstone_summit_booth:sections/npcs/dialogue/credits/render/switch/case_3/if2/execute_if
execute if entity @s[tag=sandstone_summit_booth.npc.red_tent_sandstone] run function sandstone_summit_booth:sections/npcs/dialogue/credits/render/switch/case_3/if2/execute_if2
