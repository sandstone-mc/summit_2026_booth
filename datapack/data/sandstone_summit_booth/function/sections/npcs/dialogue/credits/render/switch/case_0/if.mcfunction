...
data modify storage sandstone_summit_booth:npcs_reveal full set value "This whole thing didn't build itself, you know."
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/credits/render/switch/case_0/if/execute_at