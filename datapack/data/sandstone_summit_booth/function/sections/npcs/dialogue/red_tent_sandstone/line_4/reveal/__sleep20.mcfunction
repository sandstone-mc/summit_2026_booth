...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 4 run function sandstone_summit_booth:sections/npcs/dialogue/red_tent_sandstone/line_4/reveal/if20
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/red_tent_sandstone/line_4/reveal/__sleep21/_context 2t replace