...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 5 run function sandstone_summit_booth:sections/npcs/dialogue/red_tent_sandstone/line_5/reveal/if41
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/red_tent_sandstone/line_5/reveal/__sleep42/_context 1t replace