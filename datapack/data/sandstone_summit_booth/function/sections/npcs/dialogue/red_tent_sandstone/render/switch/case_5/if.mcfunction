...
data modify storage sandstone_summit_booth:npcs_reveal full set value 'No mods, no plugins needed. It all compiles down to a normal datapack anyone can drop into their world.'
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/red_tent_sandstone/render/switch/case_5/if/execute_at