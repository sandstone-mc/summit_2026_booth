...
data modify storage sandstone_summit_booth:npcs_reveal full set value '*That sounds too good to be true*'
...
data modify storage sandstone_summit_booth:npcs_reveal runs set value [{text:'',color:'gray',italic:true}]
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/red_tent_sandstone/render/switch/case_4/if/execute_at