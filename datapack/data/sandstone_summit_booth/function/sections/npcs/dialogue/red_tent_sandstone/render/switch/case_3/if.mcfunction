...
data modify storage sandstone_summit_booth:npcs_reveal full set value "You get autocomplete, type-checking, reusable functions... the stuff you'd expect from real software, but for vanilla Minecraft."
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/red_tent_sandstone/render/switch/case_3/if/execute_at