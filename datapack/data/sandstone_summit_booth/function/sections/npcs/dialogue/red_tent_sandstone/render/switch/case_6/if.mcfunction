...
data modify storage sandstone_summit_booth:npcs_reveal full set value "Everything you'll see here started out as TypeScript!"
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/red_tent_sandstone/render/switch/case_6/if/execute_at