...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 5 run function sandstone_summit_booth:sections/npcs/dialogue/red_tent_sandstone/line_5/show/if88
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/red_tent_sandstone/line_5/show/__sleep89/_context 1t replace