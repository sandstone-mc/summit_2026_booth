...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 2 run function sandstone_summit_booth:sections/npcs/dialogue/red_tent_sandstone/line_2/reveal/if84
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/red_tent_sandstone/line_2/reveal/__sleep85/_context 1t replace