...
data modify storage sandstone_summit_booth:npcs_reveal full set value 'I have no idea what Sandstone is...'
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/red_tent_sandstone/render/switch/case_0/if/execute_at