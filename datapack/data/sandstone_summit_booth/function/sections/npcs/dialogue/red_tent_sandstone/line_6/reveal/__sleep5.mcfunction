...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 6 run function sandstone_summit_booth:sections/npcs/dialogue/red_tent_sandstone/line_6/reveal/if5
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/red_tent_sandstone/line_6/reveal/__sleep6/_context 1t replace