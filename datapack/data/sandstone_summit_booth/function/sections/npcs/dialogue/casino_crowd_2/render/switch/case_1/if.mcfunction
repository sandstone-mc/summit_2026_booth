...
data modify storage sandstone_summit_booth:npcs_reveal full set value 'Talk to me again and I might just let you have one of these extra balloons I got.'
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/casino_crowd_2/render/switch/case_1/if/execute_at