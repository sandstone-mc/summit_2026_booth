...
data modify storage sandstone_summit_booth:npcs_reveal full set value "I got lost in the jungle for a little bit earlier, but I'm not too worried because I got a sick banner out of it!"
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/casino_crowd_2/render/switch2/case_5/if/execute_at