...
data modify storage sandstone_summit_booth:npcs_reveal full set value "I don't understand any of what is going on here, this whole island confuses me"
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/casino_crowd_2/render/switch2/case_1/if/execute_at