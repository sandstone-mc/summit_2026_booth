...
data modify storage sandstone_summit_booth:npcs_reveal full set value "There's a whole lot of words on that screen, give me another balloon!"
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/casino_crowd_2/render/switch2/case_3/if/execute_at