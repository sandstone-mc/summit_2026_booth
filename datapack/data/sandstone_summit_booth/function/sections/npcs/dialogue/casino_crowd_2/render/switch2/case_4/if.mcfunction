...
data modify storage sandstone_summit_booth:npcs_reveal full set value "I can't find this last sticker!"
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/casino_crowd_2/render/switch2/case_4/if/execute_at