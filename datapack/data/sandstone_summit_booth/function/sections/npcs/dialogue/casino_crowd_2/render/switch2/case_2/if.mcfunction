...
data modify storage sandstone_summit_booth:npcs_reveal full set value "I came to the Sandstone booth and all I got was this shirt.\n\nAnd I couldn't be happier"
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/casino_crowd_2/render/switch2/case_2/if/execute_at