...
data modify storage sandstone_summit_booth:npcs_reveal full set value 'Here you go.'
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/casino_crowd_2/render/switch/case_2/if/execute_at