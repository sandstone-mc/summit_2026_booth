...
data modify storage sandstone_summit_booth:npcs_reveal full set value 'Ah, you already got one from me recently. Come back later for another balloon!'
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/casino_crowd_2/render/switch/case_3/if/execute_at