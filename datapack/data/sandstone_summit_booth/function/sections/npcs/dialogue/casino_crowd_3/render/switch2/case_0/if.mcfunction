...
data modify storage sandstone_summit_booth:npcs_reveal full set value 'All in on red!'
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/casino_crowd_3/render/switch2/case_0/if/execute_at