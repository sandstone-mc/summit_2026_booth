...
data modify storage sandstone_summit_booth:npcs_reveal full set value 'I keep betting but this wheel never spins...'
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/casino_crowd_3/render/switch2/case_1/if/execute_at