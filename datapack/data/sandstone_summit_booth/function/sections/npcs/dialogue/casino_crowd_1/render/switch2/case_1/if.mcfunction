...
data modify storage sandstone_summit_booth:npcs_reveal full set value "I've already watched this fifteen times.\nStill good."
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/casino_crowd_1/render/switch2/case_1/if/execute_at