...
data modify storage sandstone_summit_booth:npcs_reveal full set value 'Best seat in the house for the show.'
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/casino_crowd_1/render/switch2/case_2/if/execute_at