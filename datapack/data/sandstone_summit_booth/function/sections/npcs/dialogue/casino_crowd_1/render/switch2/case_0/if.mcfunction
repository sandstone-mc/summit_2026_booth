...
data modify storage sandstone_summit_booth:npcs_reveal full set value 'This presentation is amazing, right?'
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/casino_crowd_1/render/switch2/case_0/if/execute_at