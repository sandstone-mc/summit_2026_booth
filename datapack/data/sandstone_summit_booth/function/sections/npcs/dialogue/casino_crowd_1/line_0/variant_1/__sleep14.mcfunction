...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 0 run function sandstone_summit_booth:sections/npcs/dialogue/casino_crowd_1/line_0/variant_1/if14
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/casino_crowd_1/line_0/variant_1/__sleep15/_context 1t replace