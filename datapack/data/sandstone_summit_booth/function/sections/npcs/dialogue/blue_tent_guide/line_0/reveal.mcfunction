...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/blue_tent_guide/line_0/reveal/execute_at
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/blue_tent_guide/line_0/reveal/__sleep/_context 1t replace