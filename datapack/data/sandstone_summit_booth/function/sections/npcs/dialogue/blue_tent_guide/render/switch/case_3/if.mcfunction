...
data modify storage sandstone_summit_booth:npcs_reveal full set value "Go on and explore a bit! You won't regret it."
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/blue_tent_guide/render/switch/case_3/if/execute_at