...
data modify storage sandstone_summit_booth:npcs_reveal full set value "Welcome to the Sandstone booth!\nThere's plenty to check out around here."
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/blue_tent_guide/render/switch/case_0/if/execute_at