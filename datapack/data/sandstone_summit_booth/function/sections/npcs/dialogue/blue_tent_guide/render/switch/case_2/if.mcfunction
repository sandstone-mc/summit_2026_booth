...
data modify storage sandstone_summit_booth:npcs_reveal full set value "Keep going down the elevator and you'll be able to play a couple demos of projects built in the Sandstone betas."
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/blue_tent_guide/render/switch/case_2/if/execute_at