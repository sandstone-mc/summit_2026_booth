...
data modify storage sandstone_summit_booth:npcs_reveal full set value "Head downstairs and you'll find an informative presentation all about Sandstone!"
...
execute at @s run function sandstone_summit_booth:sections/npcs/dialogue/blue_tent_guide/render/switch/case_1/if/execute_at