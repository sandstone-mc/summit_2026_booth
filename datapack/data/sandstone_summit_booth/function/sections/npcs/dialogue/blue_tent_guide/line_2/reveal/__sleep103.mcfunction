...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 2 run function sandstone_summit_booth:sections/npcs/dialogue/blue_tent_guide/line_2/reveal/if103
...
schedule function sandstone_summit_booth:sections/npcs/dialogue/blue_tent_guide/line_2/reveal/__sleep104/_context 1t replace