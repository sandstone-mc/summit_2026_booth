...
execute as @e[type=minecraft:mannequin, tag=sandstone_summit_booth.npc.credits] at @s run function sandstone_summit_booth:sections/npcs/tick/execute_as
execute as @e[type=minecraft:mannequin, tag=sandstone_summit_booth.npc.blue_tent_guide] at @s run function sandstone_summit_booth:sections/npcs/tick/execute_as2
execute as @e[type=minecraft:mannequin, tag=sandstone_summit_booth.npc.red_tent_sandstone] at @s run function sandstone_summit_booth:sections/npcs/tick/execute_as3
