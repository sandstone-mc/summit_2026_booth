...
execute as @e[tag=sandstone_summit_booth.npc.red_tent_sandstone, type=minecraft:mannequin] at @s run function sandstone_summit_booth:sections/npcs/tick/execute_as2
execute as @e[tag=sandstone_summit_booth.npc.credits, type=minecraft:mannequin] at @s run function sandstone_summit_booth:sections/npcs/tick/execute_as3
