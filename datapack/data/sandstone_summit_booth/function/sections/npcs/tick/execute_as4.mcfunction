...
scoreboard players operation anon_WnYlBycD_57 __sandstone = #global sandstone_summit_booth.npc.tick_counter
scoreboard players operation anon_WnYlBycD_57 __sandstone %= 5 __sandstone
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 0.. if score anon_WnYlBycD_57 __sandstone matches 0 run function sandstone_summit_booth:sections/npcs/tick/execute_as4/if2
