...
execute if score @s sandstone_summit_booth.npc.dialogue.line matches 0.. if score anon_WnYlBycD_84 __sandstone matches 0 run function sandstone_summit_booth:sections/npcs/tick/execute_as4/if2
