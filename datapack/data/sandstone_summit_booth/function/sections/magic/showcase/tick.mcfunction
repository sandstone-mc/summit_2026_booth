execute as @a[tag=showcase.in_magic_showcase] run tag @s remove sandstone_summit_booth.showcase.in_magic_showcase
execute as @e[tag=sandstone_summit_booth.showcase.marker, type=minecraft:marker] at @s run function sandstone_summit_booth:sections/magic/showcase/tick/execute_as2
...
execute as @a[scores={sandstone_summit_booth.showcase.reset=1..}] run function sandstone_summit_booth:sections/magic/showcase/tick/execute_as3