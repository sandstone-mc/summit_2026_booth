...
scoreboard players operation anon_WnYlBycD_67 __sandstone = magic.tick_counter.lightning_0_WnYlBycD __sandstone
scoreboard players operation anon_WnYlBycD_67 __sandstone %= 10 __sandstone
execute if score anon_WnYlBycD_67 __sandstone matches 0 run function sandstone_summit_booth:sections/magic/spells/lightning/static_field/update
