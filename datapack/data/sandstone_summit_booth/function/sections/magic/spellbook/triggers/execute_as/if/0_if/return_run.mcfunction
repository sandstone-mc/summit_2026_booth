...
execute store result storage __sandstone:variable anon_WnYlBycD_0.param_0 int 1 run scoreboard players get @s sandstone_summit_booth.set_school_trigger
function sandstone_summit_booth:sections/magic/spellbook/set_school with storage __sandstone:variable anon_WnYlBycD_0
