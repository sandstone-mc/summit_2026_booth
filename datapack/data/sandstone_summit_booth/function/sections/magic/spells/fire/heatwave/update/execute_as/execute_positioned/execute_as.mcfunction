damage @s 1 on_fire
scoreboard players set anon_WnYlBycD_46 __sandstone 2
data modify storage __sandstone:variable anon_WnYlBycD_2 set value {}
execute store result storage __sandstone:variable anon_WnYlBycD_2.param_0 int 1 run scoreboard players get anon_WnYlBycD_46 __sandstone
