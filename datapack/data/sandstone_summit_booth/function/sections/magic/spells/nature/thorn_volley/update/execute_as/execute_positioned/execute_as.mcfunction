damage @s 2 thorns
scoreboard players set anon_WnYlBycD_24 __sandstone 2
data modify storage __sandstone:variable anon_WnYlBycD_6 set value {}
execute store result storage __sandstone:variable anon_WnYlBycD_6.param_0 int 1 run scoreboard players get anon_WnYlBycD_24 __sandstone
function sandstone_summit_booth:sections/magic/status/entangled/apply with storage __sandstone:variable anon_WnYlBycD_6
particle block{block_state:'minecraft:oak_leaves'} ~ ~ ~ 0.3 0.3 0.3 0.1 10 force
