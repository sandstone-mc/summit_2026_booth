particle spore_blossom_air ~ ~ ~ 0.1 0.1 0.1 0 1 force @a[distance=0..24, distance=0,24]
particle minecraft:tinted_leaves{color:[0,1,0,1]} ~ ~ ~ 0.05 0.05 0.05 0 1 force @a[distance=0..24, distance=0,24]
tp @s ^ ^ ^0.5
