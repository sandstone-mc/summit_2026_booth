scoreboard players set anon_WnYlBycD_80 __sandstone 5
data modify storage __sandstone:variable anon_WnYlBycD_6 set value {}
execute store result storage __sandstone:variable anon_WnYlBycD_6.param_0 int 1 run scoreboard players get anon_WnYlBycD_80 __sandstone
