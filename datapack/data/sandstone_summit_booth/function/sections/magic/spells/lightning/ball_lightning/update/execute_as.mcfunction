scoreboard players operation anon_WnYlBycD_16 __sandstone = @s sandstone_summit_booth.lifetime
scoreboard players operation anon_WnYlBycD_16 __sandstone %= 10 __sandstone
