particle electric_spark ~ ~1 ~ 0.5 0.8 0.5 0.05 2 force @a[distance=0..24, distance=0,24]
particle end_rod ~ ~1.6 ~ 0.2 0.5 0.2 0.1 20 force @a[distance=0..24, distance=0,24]
