...
execute as @e[type=#sandstone_summit_booth:targetable, distance=0..6] run function sandstone_summit_booth:sections/magic/spells/ice/blizzard/update_storms/execute_as/execute_as