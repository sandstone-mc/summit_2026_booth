...
execute as @e[type=#sandstone_summit_booth:targetable, distance=0..5.5] at @s run function sandstone_summit_booth:sections/magic/spells/ice/frost_nova/cast/0_if/return_run/execute_as
