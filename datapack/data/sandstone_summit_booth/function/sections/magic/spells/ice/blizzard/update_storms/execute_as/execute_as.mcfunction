damage @s 0.1 freeze
scoreboard players set anon_WnYlBycD_59 __sandstone 2
data modify storage __sandstone:variable anon_WnYlBycD_1 set value {}
execute store result storage __sandstone:variable anon_WnYlBycD_1.param_0 int 1 run scoreboard players get anon_WnYlBycD_59 __sandstone
