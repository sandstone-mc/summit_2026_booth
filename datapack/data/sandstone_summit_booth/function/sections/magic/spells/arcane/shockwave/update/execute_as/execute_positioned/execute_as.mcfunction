...
damage @s 1 magic
execute as @e[distance=0..2, distance=0,2, tag=sandstone_summit_booth.spell.arcane.shockwave.projectile, tag=sandstone_summit_booth.spell.arcane.shockwave.projectile] run kill @s