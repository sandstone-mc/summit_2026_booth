...
execute as @e[tag=sandstone_summit_booth.spells.arcane.blink.ray_caster, limit=1] at @s anchored eyes rotated as @s run rotate @n[type=minecraft:marker, tag=sandstone_summit_booth.spells.arcane.blink.ray_active] ~ ~
tp @s ~ ~1.62 ~
