particle snowflake ~ ~1 ~ 0.1 0.25 0.1 0.01 5 force @a[distance=0..24, distance=0,24]
...
scoreboard players operation anon_WnYlBycD_66 __sandstone = @s sandstone_summit_booth.status.freezing_timer
scoreboard players operation anon_WnYlBycD_66 __sandstone %= 20 __sandstone
execute if score anon_WnYlBycD_66 __sandstone matches 0 run damage @s 1 freeze
