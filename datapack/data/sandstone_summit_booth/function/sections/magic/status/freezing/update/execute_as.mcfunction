...
scoreboard players operation anon_WnYlBycD_61 __sandstone = @s sandstone_summit_booth.status.freezing_timer
scoreboard players operation anon_WnYlBycD_61 __sandstone %= 20 __sandstone
execute if score anon_WnYlBycD_61 __sandstone matches 0 run damage @s 1 freeze
