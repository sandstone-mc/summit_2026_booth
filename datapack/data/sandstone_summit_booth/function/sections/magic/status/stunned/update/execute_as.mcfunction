...
scoreboard players operation anon_WnYlBycD_44 __sandstone = @s sandstone_summit_booth.status.stunned_timer
scoreboard players operation anon_WnYlBycD_44 __sandstone %= 1000 __sandstone
execute if score anon_WnYlBycD_44 __sandstone matches 0 run damage @s 0 generic
