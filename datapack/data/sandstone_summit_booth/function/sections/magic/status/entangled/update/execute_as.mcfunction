...
scoreboard players operation anon_WnYlBycD_44 __sandstone = @s sandstone_summit_booth.status.entangled_timer
scoreboard players operation anon_WnYlBycD_44 __sandstone %= 15 __sandstone
execute if score anon_WnYlBycD_44 __sandstone matches 0 run damage @s 1 cactus
