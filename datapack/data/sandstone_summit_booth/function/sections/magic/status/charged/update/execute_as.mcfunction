...
scoreboard players operation anon_WnYlBycD_70 __sandstone = @s sandstone_summit_booth.status.charged_timer
scoreboard players operation anon_WnYlBycD_70 __sandstone %= 30 __sandstone
execute if score anon_WnYlBycD_70 __sandstone matches 0 run damage @s 1 lightning_bolt
