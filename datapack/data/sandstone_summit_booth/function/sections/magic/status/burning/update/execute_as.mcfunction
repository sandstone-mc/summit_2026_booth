...
scoreboard players operation anon_WnYlBycD_2 __sandstone = @s sandstone_summit_booth.status.burning_timer
scoreboard players operation anon_WnYlBycD_2 __sandstone %= 20 __sandstone
execute if score anon_WnYlBycD_2 __sandstone matches 0 run damage @s 1 on_fire
