scoreboard players set anon_WnYlBycD_5 __sandstone 2
execute as @a[tag=snd.rhythm.player, tag=snd.rhythm.player] run function sandstone_summit_booth:sections/rhythm/active/init/execute_as
