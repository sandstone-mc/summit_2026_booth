...
execute if score anon_WnYlBycD_6 __sandstone matches 2.. run return run function sandstone_summit_booth:sections/rhythm/settings/update/0_if/return_run
...
data merge entity @e[type=minecraft:text_display, tag=snd.ui.set.cal, limit=1] {text:[{text:'  ⌛ Calibration:       ',color:'gray'},{text:'◀ ▶                   ',color:'aqua'}]}
