...
execute as @e[tag=ssb.wall, tag=ssb.wall.init] run function sandstone_summit_booth:sections/rhythm/wall/tick/if/execute_in/execute_as
execute as @e[tag=ssb.wall.wait] run function sandstone_summit_booth:sections/rhythm/wall/tick/if/execute_in/execute_as2
execute as @e[tag=ssb.wall.new] run function sandstone_summit_booth:sections/rhythm/wall/tick/if/execute_in/execute_as3
