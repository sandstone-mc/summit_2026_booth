...
execute as @e[tag=ssb.rhythm.wall, tag=ssb.rhythm.wall.init, tag=!ssb.rhythm.parkour] run scoreboard players set @s sandstone_summit_booth.rhythm.wall.depth 0
...
execute if entity @e[scores={sandstone_summit_booth.rhythm.wall.age=42..42}, tag=ssb.rhythm.wall] run scoreboard players set anon_WnYlBycD_10 __sandstone 1
execute as @e[scores={sandstone_summit_booth.rhythm.wall.age=76..76}, tag=ssb.rhythm.wall] run tp @s -70 -64 55
