...
execute as @e[type=#sandstone_summit_booth:rhythm_wall, tag=snd.rhythm.wall, tag=snd.rhythm.wall.init, tag=!snd.rhythm.parkour] run scoreboard players operation @s sandstone_summit_booth.rhythm.wall.depth = anon_WnYlBycD_44 __sandstone
...
execute if entity @e[type=#sandstone_summit_booth:rhythm_wall, tag=snd.rhythm.wall, scores={sandstone_summit_booth.rhythm.wall.age=42..42}] run scoreboard players set anon_WnYlBycD_16 __sandstone 1
