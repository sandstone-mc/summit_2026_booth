...
execute as @e[tag=ssb.rhythm.wall, tag=ssb.rhythm.wall.init, tag=!ssb.rhythm.parkour] run scoreboard players operation @s sandstone_summit_booth.rhythm.wall.depth = anon_WnYlBycD_6 __sandstone
...
execute if entity @e[scores={sandstone_summit_booth.rhythm.wall.age=42..42}, tag=ssb.rhythm.wall] run scoreboard players set anon_WnYlBycD_19 __sandstone 1
