...
execute if entity @e[tag=snd.rhythm.wall, scores={sandstone_summit_booth.rhythm.wall.age=42..42}] run scoreboard players set anon_WnYlBycD_16 __sandstone 1
execute as @e[tag=snd.rhythm.wall, scores={sandstone_summit_booth.rhythm.wall.age=76..76}] run tp @s -70 -64 54
kill @e[tag=snd.rhythm.wall, scores={sandstone_summit_booth.rhythm.wall.age=77..}]