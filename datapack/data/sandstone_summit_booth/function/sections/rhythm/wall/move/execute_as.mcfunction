...
execute if score @s sandstone_summit_booth.rhythm.wall.temp > anon_WnYlBycD_9 __sandstone run scoreboard players operation @s sandstone_summit_booth.rhythm.wall.temp = anon_WnYlBycD_9 __sandstone
scoreboard players operation @s sandstone_summit_booth.rhythm.wall.temp *= anon_WnYlBycD_8 __sandstone
