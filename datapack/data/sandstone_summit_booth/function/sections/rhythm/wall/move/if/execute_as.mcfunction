...
execute if score @s sandstone_summit_booth.rhythm.wall.temp > anon_WnYlBycD_16 __sandstone run scoreboard players operation @s sandstone_summit_booth.rhythm.wall.temp = anon_WnYlBycD_16 __sandstone
scoreboard players operation @s sandstone_summit_booth.rhythm.wall.temp *= anon_WnYlBycD_15 __sandstone
scoreboard players operation @s sandstone_summit_booth.rhythm.wall.temp /= anon_WnYlBycD_16 __sandstone
