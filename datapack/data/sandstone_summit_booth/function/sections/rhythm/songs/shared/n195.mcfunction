...
execute as @a[tag=sandstone_summit_booth.rhythm.showcase.listener] at @s run playsound block.note_block.harp master @s ~ ~ ~ 0.7645669291338583 0.5946035575013605
execute as @a[tag=sandstone_summit_booth.rhythm.showcase.listener] at @s run playsound block.note_block.harp master @s ~ ~ ~ 0.7645669291338583 0.5946035575013605
