...
execute as @a[tag=sandstone_summit_booth.rhythm.showcase.listener] at @s run playsound block.note_block.harp master @s ~ ~ ~ 0.7409448818897637 0.6299605249474366
execute as @a[tag=sandstone_summit_booth.rhythm.showcase.listener] at @s run playsound block.note_block.harp master @s ~ ~ ~ 0.7409448818897637 0.6299605249474366
