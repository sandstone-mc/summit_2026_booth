...
execute if score anon_WnYlBycD_40 __sandstone matches ..0 unless entity @e[tag=ssb.rhythm.wall] run function sandstone_summit_booth:sections/rhythm/end/run