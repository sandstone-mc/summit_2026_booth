summon minecraft:block_display 3 68 30 {Tags:['ssb.wall','ssb.wall.new','ssb.parkour'],block_state:{Name:'minecraft:pink_stained_glass'},interpolation_duration:80i,transformation:{translation:[-0.5f,0f,-0.5f],left_rotation:[0f,0f,0f,1f],scale:[1f,1f,2f],right_rotation:[0f,0f,0f,1f]}}
