...
execute if score anon_WnYlBycD_40 __sandstone matches ..0 run advancement grant @a[tag=snd.rhythm.player, scores={sandstone_summit_booth.rhythm.wall.lives=1..}] only summit.sticker_book:sandstone_summit_booth/rhythm
