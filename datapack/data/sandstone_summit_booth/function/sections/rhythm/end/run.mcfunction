...
execute if score anon_WnYlBycD_46 __sandstone matches ..0 run advancement grant @a[scores={sandstone_summit_booth.rhythm.wall.lives=1..}, tag=ssb.rhythm.player] only summit.sticker_book:sandstone_summit_booth/rhythm
