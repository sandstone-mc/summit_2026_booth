...
tp @a[tag=snd.rhythm.player, tag=snd.rhythm.player] -70 64 54
execute as @a[tag=snd.rhythm.player, tag=snd.rhythm.player] run function sandstone_summit_booth:sections/rhythm/reset_player
