execute as @e[tag=sandstone_summit_booth.elevator.car, type=minecraft:block_display, limit=1] at @a[tag=sandstone_summit_booth.elevator.driver, gamemode=!spectator, limit=1] run tp @s -55 ~-0.5 46
