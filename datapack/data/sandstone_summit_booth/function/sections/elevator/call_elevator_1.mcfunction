...
execute if entity @a[tag=sandstone_summit_booth.elevator.rider, tag=sandstone_summit_booth.elevator.rider] run return run function sandstone_summit_booth:sections/elevator/call_elevator_1/0_if/return_run
