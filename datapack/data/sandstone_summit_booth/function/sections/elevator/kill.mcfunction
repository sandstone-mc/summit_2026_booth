execute as @a[tag=sandstone_summit_booth.elevator.rider, tag=sandstone_summit_booth.elevator.rider] run function sandstone_summit_booth:sections/elevator/kill/execute_as
kill @e[type=minecraft:block_display, limit=1, tag=sandstone_summit_booth.elevator.car, tag=sandstone_summit_booth.elevator.car]
kill @e[tag=sandstone_summit_booth.elevator.car_part, tag=sandstone_summit_booth.elevator.car_part]
kill @e[tag=sandstone_summit_booth.elevator.button, tag=sandstone_summit_booth.elevator.button]
