...
execute unless entity @a[tag=sandstone_summit_booth.elevator.driver, limit=1] run function sandstone_summit_booth:sections/elevator/inside_button_reward/1/if/if
