...
execute unless entity @a[tag=sandstone_summit_booth.elevator.driver, gamemode=!spectator, limit=1] run function sandstone_summit_booth:sections/elevator/inside_button_reward/0/if/if
execute as @a[tag=sandstone_summit_booth.elevator.rider] run function sandstone_summit_booth:sections/elevator/inside_button_reward/0/if/execute_as4
execute if score anon_WnYlBycD_1 __sandstone < anon_WnYlBycD_0 __sandstone run function sandstone_summit_booth:sections/elevator/inside_button_reward/0/if/if2
