...
execute unless entity @a[tag=sandstone_summit_booth.elevator.driver, gamemode=!spectator, limit=1] run function sandstone_summit_booth:sections/elevator/inside_button_reward/0/if/if/if
