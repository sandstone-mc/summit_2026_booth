...
execute as @a[tag=sandstone_summit_booth.elevator.rider] run function sandstone_summit_booth:sections/elevator/call_elevator_1/if/if/return_run/execute_as12
fill -57 74 45 -58 77 46 minecraft:air
