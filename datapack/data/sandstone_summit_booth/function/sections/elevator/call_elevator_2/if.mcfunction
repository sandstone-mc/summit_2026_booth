execute if entity @a[tag=sandstone_summit_booth.elevator.rider] run return run schedule function sandstone_summit_booth:sections/elevator/call_elevator_2/__sleep 1s append
...
schedule function sandstone_summit_booth:sections/elevator/call_elevator_2/__sleep3 2s append