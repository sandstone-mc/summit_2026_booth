...
execute unless entity @a[tag=sandstone_summit_booth.elevator.driver, limit=1, gamemode=!spectator] run function sandstone_summit_booth:sections/elevator/floors/2/go/if/if
