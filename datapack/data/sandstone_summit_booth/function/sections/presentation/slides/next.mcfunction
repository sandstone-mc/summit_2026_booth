...
execute store result storage __sandstone:variable anon_WnYlBycD_117.env_0 int 1 run scoreboard players get #current sandstone_summit_booth.presentation.slide_idx
return run function sandstone_summit_booth:sections/presentation/slides/next/switch/dispatch with storage __sandstone:variable anon_WnYlBycD_117