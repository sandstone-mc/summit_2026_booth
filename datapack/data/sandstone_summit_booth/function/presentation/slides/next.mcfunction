...
execute if score #current sandstone_summit_booth.presentation.slide_idx matches 21.. run scoreboard players set #current sandstone_summit_booth.presentation.slide_idx 0
