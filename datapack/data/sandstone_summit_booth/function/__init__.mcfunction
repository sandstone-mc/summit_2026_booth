...
scoreboard objectives add sandstone_summit_booth.rhythm.state dummy
...
scoreboard objectives add sandstone_summit_booth.rhythm.wall_variable dummy
scoreboard objectives add sandstone_summit_booth.rhythm.wall.move dummy
...
scoreboard objectives add sandstone_summit_booth.rhythm.parkour dummy
