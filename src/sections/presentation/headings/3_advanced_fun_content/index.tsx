...
export const slides = [
	...
	// 		<explorer
	// 			width="20vw"
	// 			path-start={3 /* Explorer starts with `data/sandstone_summit_booth/function/sections/rhythm/calibration` */}
	...
	// 		<explorer
	// 			width="20vw"
	// 			path-start={3 /* Explorer starts with `data/sandstone_summit_booth/function/sections/magic/spells/lightning/thunderbolt` */}
